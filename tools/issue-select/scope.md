...
I have hands-on experience with Java and Python, and I'm comfortable with
Git and the GitHub pull-request workflow. I want to get better at Scala
and TypeScript, so I'd love issues in those languages that stretch me
while staying approachable given my JVM (Java) and general programming
background. I'd prefer to avoid heavy frontend/CSS and pixel-level styling
work.
